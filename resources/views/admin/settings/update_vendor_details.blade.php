...
<div class="main-panel">
   ...
   <input class="form-control" value="{{Auth::guard('admin')->user()->email}}" readonly="">
      ...
      <label for="vendor_name">Name</label>
       <input type="text" class="form-control" value="{{ Auth::guard('admin')->user()->name }}" id="vendor_name" placeholder="Enter Name" name="vendor_name">
                ...
                <input type="text" class="form-control" id="vendor_mobile" placeholder="Enter 10 digit Mobile No" name="vendor_mobile" required="" maxlength="10" minlength="10" value="{{Auth::guard('admin')->user()->mobile }}">
                                  </div>
...
<input type="text" class="form-control" value="{{ $vendorDetails['shop_name']}}" id="shop_name" placeholder="Enter Shop Name" name="shop_name">
        ...
        <input type="text" class="form-control" id="shop_mobile" placeholder="Enter 10 digit Mobile No" name="shop_mobile" required="" maxlength="10" minlength="10" value="{{ $vendorDetails['shop_mobile']}}">
                          </div>
...
<input type="text" class="form-control" value="{{ $vendorDetails['account_holder_name']}}" id="account_holder_name" placeholder="Enter Account Holder Name" name="account_holder_name">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                      <label for="bank_ifsc_code">Bank IFSC Code</label>
                       <input type="text" class="form-control" id="bank_ifsc_code" placeholder="Enter IFSC Code" name="bank_ifsc_code" value="{{ $vendorDetails['bank_ifsc_code']}}">
